...
{
    public class DColorShaderer                   // 191 lines
    {
        // Structures.
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandle, string vsFileName, string psFileName)
        {
            try
            {
                ...
                /*var vsFileNameByteArray = SC_Console_APP.Properties.Resources.Color1;
                var psFileNameByteArray = SC_Console_APP.Properties.Resources.Color;
                ...
                */
                var vsFileNameByteArray = ShaderFilePath + "Color.vs";
                var psFileNameByteArray = ShaderFilePath + "Color.ps";
                //var vsFileNameByteArray = SC_Console_APP.Properties.Resources.Color;
                //var psFileNameByteArray = SC_Console_APP.Properties.Resources.Color1;
